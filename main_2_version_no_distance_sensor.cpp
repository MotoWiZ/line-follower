...
float volt, motorSpeed, position, P, I, D, lastP, kP=0.3, kI=0.1, kD=0.05;
...
void right_run()
{
    position = (4000L * normSensor[0] + 3000L * normSensor[1] + 2000L * normSensor[2] + 1000L * normSensor[3] + 0 * normSensor[4])
    / (normSensor[0] + normSensor[1] + normSensor[2] + normSensor[3] + normSensor[4]);
